...
module.exports = {
    async createDataByXlsxFile(req, res) {
         /*
          ...
          #swagger.summary = 'Envio de dados através de arquivo xlsx'
          #swagger.description = 'Insira todos os dados de uma tabela excel em um usuário específico. A tabela deve conter os campos price, typeofexpenses, date e name. Nenhum campo pode estar vazio, ou retornará um erro.'
    ...
    async deleteFin(req, res) {
        /*
        #swagger.tags = ["finanças"]
        #swagger.summary = 'Deleta uma despesa apartir do userid e financeid'
         #swagger.description = 'Deleta uma despesa com o id = financeid do usuário = userid'
    ...
    async totalexpenses(req, res) {
       ...
       // #swagger.description = 'Utilize o userid, para retornar as despesas do usuário, podendo usar uma query ou outra para retornar por mês ou por tipo'
        const { userid } = req.params
